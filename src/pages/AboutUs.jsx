  ...
  return (
    <div className="background-image">
      ...
      <div class="about-section">
        <h2>Our Team</h2>
        <p>
          The team is debating how to construct a project around wine and
          farming.
        </p>
      </div>
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="">
              ...
              <p>
                Managing Director is focused on the highly-specialized
                day-to-day
                <br />
                business initiatives that must be implemented to achieve those
                <br />
                goals in specific areas of focus (product, sales, etc.).
              </p>
              <p>Ndu@gmail.com</p>
              <p>
          ...
          <div class="card">
            ...
            <div class="">
              ...
              <p>
                ...
                <br />
                managing overall operations, and setting the company's strategic
                <br />
                direction.
              </p>
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="">
              ...
              <p>
                {" "}
                Business designers think about how every element of the
                <br />
                business model affects the consumer and client
                <br />
                experience
              </p>
              <p>Bonke@gmail.com</p>
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="">
              ...
              <p>
                Leadership is the act of guiding a team or individual to achieve
                <br />a certain goal through direction and motivation.
              </p>
              <p>Sonke@gmail.com</p>
              <p>
                <button class="button">Contact</button>
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="">
              ...
              <p>
                A group of people who work for an organization, often for a
                special
                <br /> purpose, or who work for a manager within an organization
              </p>
          ...
          <div class="card">
            ...
            <div class="">
              ...
              <p>
                ...
                Depending on the
                <br /> company, a supervisor may manage a team, a shift or an
                entire department.{" "}
              </p>
